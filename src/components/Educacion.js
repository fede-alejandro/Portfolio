...
function Educacion() {
    ...
    return <main className='flex flex-row justify-center  gap-36 w-full p-20 text-[#c6d6dd]'>
        ...
        <div className="flex flex-col gap-10">
            <div className='flex flex-col  items-center border-2 border-[#c6d6dd] rounded-md p-4 w-[40rem] gap-2'>
            ...
            <div className='flex flex-col items-center border-2 border-[#c6d6dd] rounded-md  p-4 w-[40rem]'>
